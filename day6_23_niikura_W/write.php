...
<html lang="ja">
    ...
    <body>
        ...
        <?php
            ...
            //データ登録SQL作成
            // 1. SQL文を用意
                $stmt = $pdo->prepare("INSERT INTO gs_bm_table(unique_code, fname, lname, mail1, mail2,address1,address2,address3,address4,phone,phone_hyoji,date)
                                                        VALUES(NULL, :fname, :lname, :mail1, :mail2,:address1,:address2,:address3,:address4,:phone,:phone_hyoji, sysdate())");
